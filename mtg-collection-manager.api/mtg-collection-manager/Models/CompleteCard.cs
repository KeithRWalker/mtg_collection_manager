...
namespace mtg_collection_manager.Models
{
    ...
    public class ConvertCard
    {
        ...
        public List<string> Games { get; set; }
        public List<Guid> ArtistIds { get; set; }
        public List<ConvertCardFace> CardFaces { get; set; }
        public ConvertCardLegalities Legalities { get; set; }
        public ConvertCardPrices Prices { get; set; }
        public ConvertCardRelatedUris RelatedUris { get; set; }
        public ConvertCardImageUris ImageUris { get; set; }
        public ConvertCardPurchaseUris PurchaseUris { get; set; }
    }

    public class ConvertCardMultiverseId
    {
        public long MultiverseId { get; set; }
    }

    public partial class ConvertCardFace
    {
        public string Object { get; set; }
        public string Name { get; set; }
        public string PrintedName { get; set; }
        ...
        public Guid ArtistId { get; set; }
        public Guid IllustrationId { get; set; }
        public ConvertCardCardFaceImageUris CardFaceImageUris { get; set; }
    }

    public partial class ConvertCardCardFaceImageUris
    {
        public string Small { get; set; }
        public string Normal { get; set; }
        public string Large { get; set; }
    ...
    public partial class ConvertCardImageUris
    {
        public string Small { get; set; }
        public string Normal { get; set; }
        public string Large { get; set; }
    ...
    public partial class ConvertCardLegalities
    {
        public string Standard { get; set; }
        public string Future { get; set; }
        public string Historic { get; set; }
    ...
    public partial class ConvertCardPrices
    {
        public string Usd { get; set; }
        public string UsdFoil { get; set; }
        public string Eur { get; set; }
    ...
    public partial class ConvertCardPurchaseUris
    {
        public string Tcgplayer { get; set; }
        public string Cardmarket { get; set; }
        public string Cardhoarder { get; set; }
    ...
    public partial class ConvertCardRelatedUris
    {
        public string Gatherer { get; set; }
        public string TcgplayerDecks { get; set; }
        public string Edhrec { get; set; }
